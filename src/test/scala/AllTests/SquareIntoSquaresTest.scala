...
import AllTests.SquareIntoSquaresTest.{dotest, *}
import SquareIntoSquares.*
import org.scalatest.*
import org.scalatest.Assertions.*

class SquareIntoSquaresTest extends flatspec.AnyFlatSpec {
...
object SquareIntoSquaresTest {
  ...
  private def dotest(n: Long, sexp: String): Unit = {
    ...
    val sact: String = SquareDecomposeIntoSquares.decompose(n)
